...
router.post ('/skill/:id', auth.verifyEngineer,controller.postSkillEngineer); // localhost:5000/engineer/skill/:id_engineer/
...
router.delete ('/skill/:skill_item', controller.deleteSkillEngineer); // localhost:5000/engineer/skill/:id_skill_item/:id_engineer/
